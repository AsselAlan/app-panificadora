...
const DebtPaymentModal: React.FC<{ client: any, onClose: () => void, onSuccess: (ticketData: any) => void }> = ({ client, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in">
      <div className="bg-bg-surface shadow-sm border border-brand-muted/20 rounded-3xl w-full max-w-sm flex flex-col shadow-2xl">
        <div className="p-6 border-b border-brand-muted/20 flex justify-between items-start">
          <div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <button 
              ...
              className="text-[10px] text-brand-navy font-bold mt-1 hover:underline"
            >
              Abonar total
            </button>
          </div>
    ...
    {/* Gráfico Pizza e Historial */}
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="bg-bg-surface shadow-sm border border-brand-muted/20 rounded-3xl overflow-hidden shadow-lg flex-1 min-h-[250px] max-h-[500px] flex flex-col">
          ...
          <div className="overflow-y-auto overflow-x-auto p-2 flex-1">
            <table className="w-full min-w-[650px] text-left border-collapse text-[11px] font-mono">
              <thead>
