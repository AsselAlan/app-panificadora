-- ==========================================
-- ACTUALIZACIÓN V0.10 - COMPROBANTES ABIERTOS / BORRADOR
-- ==========================================
...
CREATE INDEX IF NOT EXISTS idx_sales_driver_status ON public.sales(driver_id, status);

-- 2. Actualizar función RPC process_offline_sale para manejar upsert y status ('draft' vs 'completed')
