...
10.- **Corrección de Modal Paradas de Carga en Ruta:** Se solucionó la renderización del modal `<DriverLoadStopsModal />` en la vista `DriverHome` cuando el chofer se encuentra en estado `En Ruta`, permitiendo consultar la mercadería planificada y las recargas sin bloqueos.
